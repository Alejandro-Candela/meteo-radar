...
class SupabaseClient:
    ...
    def get_layer_url(self, bbox: tuple, variable: str, timestamp: datetime, ext=".tif") -> Optional[str]:
        """
        ...
        try:
             ...
             # Note: We rely on filename in DB. If we change to PNG, we look for PNG.
             # Construct partial query or just select by metadata?
             # Let's search by metadata: region, var, date.
    ...
    def upload_file(self, file_path: str, bbox: tuple, variable: str, timestamp: datetime, ext=".tif", mime="image/tiff") -> Optional[str]:
        """
